            ...
            $('#tableBoucher tbody').on('click', 'tr', function(e){
                if($(this).is('.selected')) {
                    ...
                    if($(this).is('.selected')) {
                        ...
                        if(faltan <= 0){
                            alert("Puntos Completos Para esta Cambio...");
                        }
                        else{
                            ptsAplic = ptsAplic + parseInt(pntos);
       ...
       console.log(this.id);
        ...
        switch (link)
        {
            ...
            case 'mdpReport':
                ...
                break;
                /*mostrar tablas nuevos reportes*/
            case 'mdpPuntos':
                hideShow('reportePuntos');+
                $('#tablereportePuntos').DataTable();
                break;
            case 'mdpPuntoCliente':
                hideShow('reportePunto');+
                $('#tablereportePcliente').DataTable();
                break;
            case 'mdpFactAnulada':
                hideShow('reportefacta');+
                $('#tablereportefacta').DataTable();
                break;
            case 'mdpFactura':
                hideShow('Factura');+
...
function  generarReporte(menuLink, fecha1, fecha2,cliente){
    ...
    switch (menuLink) {
        case 'clientesReport':
            ...
            $('#tableReporteClientes').DataTable({
                ...
                ajax: "clientesReport/"+ fecha1 +'/'+ fecha2 +'/'+ cliente,
                "ordering": false,
                "info": false,
                "pagingType": "full_numbers",
                "lengthMenu": [[10, -1], [10, "Todo"]],
      ...
      /********** Nuevos reportes...........**************/
            /*tabla punto por producto...*/
            case 'mdpPuntos':
            $("#T5D1").html(fecha1);
            $("#T5D2").html(fecha2);
            Objtable = $('#tablereportePuntos').DataTable();
            Objtable.destroy();
            Objtable.clear();
            Objtable.draw();
            $('#tablereportePuntos').DataTable({
            ...
            break;
            /*tabla punto por Cliente...*/
            case 'mdpPuntoCliente':
            $("#T6D1").html(fecha1);
            $("#T6D2").html(fecha2);
            Objtable = $('#tablereportePcliente').DataTable();
            Objtable.destroy();
            Objtable.clear();
            Objtable.draw();
            $('#tablereportePcliente').DataTable({
                ...
                ajax: "mdpPuntoCliente/"+ fecha1 +'/'+ fecha2,
                "ordering": false,
                "info": false,
                "pagingType": "full_numbers",
                "lengthMenu": [[10, -1], [10, "Todo"]],
            ...
            /*tabla facturas anuladas*/
            case 'mdpFactAnulada':
            $("#T7D1").html(fecha1);
            $("#T7D2").html(fecha2);
            Objtable = $('#tablereportefacta').DataTable();
            Objtable.destroy();
            Objtable.clear();
            Objtable.draw();
            $('#tablereportefacta').DataTable({
                ...
                ajax: "mdpFactAnulada/"+ fecha1 +'/'+ fecha2,
                "ordering": false,
                "info": false,
                "pagingType": "full_numbers",
                "lengthMenu": [[10, -1], [10, "Todo"]],
            ...
            $("#T8D1").html(fecha1);
            $("#T8D2").html(fecha2);
            Objtable = $('#tableFactura').DataTable();
            Objtable.destroy();
            Objtable.clear();
            Objtable.draw();
            $('#tableFactura').DataTable({
